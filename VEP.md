...
Screenshot from 2023-04-14 19-18-41
Screenshot from 2023-04-14 19-18-41723×418 66.6 KB

visual2
visual21296×739 184 KB

relation_diagram_for_financial_rules_metadata
relation_diagram_for_financial_rules_metadata1021×515 74 KB

rule_encoder
rule_encoder1419×810 205 KB
...
There are references in Ethereum but they don’t exist in Venon yet.
Open question:
...
Required knowledge base:
    ...
    Good level in the discussion and development of smart contracts, standard protocols for a decentralized environment.
    Expose Idea software (business logic) via an executable script.sh .
    Expose regulatory idea by visual diagram or metadata Idea through JSON/YAML structure.
    Venom Faucet for Developers to request Test Venom tokens to your wallet
    Upload a dummy smart contract as wallet-to-wallet transfer.
    Write the code hash or address at VEP forum for check address. like this d22feffdf35dad582ae1b75aea7e313afaf574594d26c605750ba13f96aa11fb
    Welcome to the hackathon with venom-financial-instruments.
...
Contributors
    ...
    We do not doubt that you are the best developer or the best businessman but we can only see your capacity through the facts and the commitment that the effort gives. The rest is luck. It is a long-term core project and required by Fintech Defi that want to be regulated to trade financial instruments. (DEX, BROKERS, BANKS, FINANCIAL AUTHORITIES, AUDITORS, NOTARIES, LAWYERS…) and create an autonomous community of experts in Venom for international financial instruments.

        It is blind contact through facts and milestones without background by skills. It is necessary to verify knowledge. -estimated time: around 20 hours from scratch-
        ...
        It is not an interview, do not send personal data to forum or chats. It is a selection by operational capacity for the hackathon. Members are anonymous unless they want to be published.
    ...
    :rocket: For projects looking for individuals: (for taking part in the hackathon. If so DM at forum)
        ...
        Type of remuneration: Collaborator. It is a long-maintenance MIT license project. The award is entirely for collaborators in proportion to the work plan for fintech and devs. These projects are important because they build community awareness and standards for Venom.
        Hackathon: venom-financial-instruments | Buidls | DoraHacks
